# Define additional KPIs with sub-KPIs
additional_kpi_structure = {
    'Biodiversity': [
        'Protected areas (% of total territorial area)',
        'Threatened species (% of total species)'
    ],
    'Water Quality': [
        'Freshwater withdrawal (% of total renewable water resources)',
        'Water stress (% of total renewable water resources)'
    ],
    'Forest Management': [
        'Forest area (% of land area)',
        'Deforestation rate (% of forest area)'
    ]
}

# Merge the additional KPIs with the existing structure
kpi_structure.update(additional_kpi_structure)
...
# Save the workbook
filename = 'Enhanced_Environmental_KPI_Table_Expanded.xlsx'
wb.save(filename)

print(f"Enhanced KPI table with additional KPIs has been saved as {filename}")

# Display the first few rows of the KPI table
print("\
First few rows of the Enhanced KPI table with additional KPIs:")
