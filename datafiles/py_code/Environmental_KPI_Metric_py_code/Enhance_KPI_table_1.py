# Instead of pivoting, let's group by the necessary columns and calculate the mean to avoid duplicates
levant_data_grouped = levant_data.groupby(['Year', 'Indicator Name']).agg({'Value': 'mean'}).reset_index()
...
levant_data_grouped.name = 'Levant Data'

data_sources = [tracking_data, pivot_data, levant_data_grouped]
